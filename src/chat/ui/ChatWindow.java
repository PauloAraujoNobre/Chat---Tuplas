...
public class ChatWindow extends JFrame {
	...
	private void setUpGUI() {
		...
		this.setTitle("Room " + roomName + " - User: " + username);
		...
		quitRoomButton.setText("Exit");
		quitRoomButton.setBounds(15, 18, 100, 25);

		JLabel chatLabel = new JLabel("ROOM " + roomName.toUpperCase());
		...
		chatArea.append("\n Wellcome to room " + roomName 
				+ "\n Send '/pm UserName Message' to send private messages and /users to list all users in class");
			...
			if (message.startsWith("/users")) {
				...
				if (message.startsWith("/pm")) {
					...
					try {
						...
						chatArea.append("\n** Private Message sended " + sp[1] + ": " + sp[2] + " **");
					} catch (Exception e) {
						msg.content = message;
						msg.isPrivate = false;
					}
